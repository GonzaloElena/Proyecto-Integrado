...
login varchar(15)  constraint uq_login unique,
password char(32) not null,
email char(32) constraint uq_email unique
);

insert into usuarios (login, password, email) values ('Tehgriefer', md5('tehgriefer1'), 'tehgriefer@gmail.com');
insert into usuarios (login, password, email) values ('Barbaro', md5('barbaro1'), 'barbaro@gmail.com');
insert into usuarios (login, password, email) values ('Mago', md5('mago1'), 'mago@gmail.com');
insert into usuarios (login, password, email) values ('Monje', md5('monje1'), 'monje@gmail.com');
insert into usuarios (login, password, email) values ('cazador', md5('cazador1'), 'cazador@gmail.com');
